...
def test_extract_id():
    ...
    assert extractor.extract_id(file, -2) == 21
...
def test_extract_gender():
    ...
    assert extractor.extract_gender(file, -3) == 'Male'
...
def test_extract_dob():
    ...
    assert extractor.extract_dob(file, -2) == '10/10/2010'
    assert extractor.extract_dob(file, -6) is None
...
def test_extract_email():
    ...
    assert extractor.extract_email(file, -1) == 'ted@outlook.com'
    assert extractor.extract_dob(file, -7) is None
...
def test_extract_city():
    ...
    assert extractor.extract_city(file, -3) == 'London'
    assert extractor.extract_city(file, -9) is None
...
def test_extract_address():
    ...
    assert extractor.extract_address(file, -1) == '3 London Road'
...
def test_extract_postcode():
    ...
    assert extractor.extract_postcode(file, -3) == 'EC2Y'
    assert extractor.extract_postcode(file, -11) is None
...
def test_extract_phone_number():
    ...
    assert extractor.extract_phone_number(file, -1) == '+448754'
...
def test_extract_university():
    ...
    assert extractor.extract_university(file, -2) == 'Cambridge'
    assert extractor.extract_university(file, -7) is None
...
def test_extract_degree():
    ...
    assert extractor.extract_degree(file, -2) == '2:1'
...
def test_extract_invited_date():
    ...
    assert extractor.extract_invited_date(file, -1) == 2
...
def test_extract_month():
    ...
    assert extractor.extract_month(file, -3) == 'APRIL 2000'
    assert extractor.extract_month(file, -5) is None
...
def test_extract_invited_by():
    ...
    assert extractor.extract_invited_by(file, -1) == 'Harry'
    assert extractor.extract_invited_by(file, -4) is None
