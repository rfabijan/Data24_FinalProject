...
def test_extract_single_json():
    get_values = values.extract_single_json('Talent/10384.json')
...
def test_extract_name():
    file = values.extract_single_json('Talent/10383.json')
...
def test_extract_date():
    file = values.extract_single_json('Talent/10450.json')
...
def test_extract_tech_self_score():
    file = values.extract_single_json('Talent/10458.json')
...
def test_extract_strengths():
    file = values.extract_single_json('Talent/10474.json')
...
def test_extract_weaknesses():
    file = values.extract_single_json('Talent/10661.json')
...
def test_extract_self_development():
    file = values.extract_single_json('Talent/10836.json')
...
def test_extract_geo_flex():
    file = values.extract_single_json('Talent/10887.json')
...
def test_extract_financial_support_self():
    file = values.extract_single_json('Talent/11040.json')
...
def test_extract_result():
    file = values.extract_single_json('Talent/11098.json')
...
def test_extract_course_interest():
    file = values.extract_single_json('Talent/11579.json')
